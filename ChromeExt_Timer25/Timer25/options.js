...
function i18n () {
    document.getElementById("msgstyle__session").textContent = chrome.i18n.getMessage("messageBoxStyle")
    document.getElementById("extraoption__session").textContent = chrome.i18n.getMessage("extraOptions")
